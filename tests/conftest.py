...
def scenario_handler_instance():
    ...
    ewr_sh = scenario_handling.ScenarioHandler(scenarios, model_format)#, climate, allowance
...
def observed_handler_instance():
    ...
    with patch("mdba_gauge_getter.gauge_getter.gauge_pull", side_effect=gg_pull_mock):
        ewr_oh = observed_handling.ObservedHandler(gauges, dates, parameter_sheet='unit_testing_files/parameter_sheet.csv')#, climate, allowance

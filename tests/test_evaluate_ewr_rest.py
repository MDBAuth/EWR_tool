...
def test_get_event_years():
	...
	'''
	EWR_info = {'events_per_year': 2,'min_event': 5, 'duration':5}
...
def test_get_achievements():
	...
	'''
	EWR_info = {'events_per_year': 1, 'min_event':5, 'duration': 5}
	events = {2012: [[5]*5, [10]*5, [20]*8], 2013: [[50]*20],
					2014: [[5]*5, [10]*5, [20]*8, [20]*8], 2015: []}
	unique_water_years = [2012, 2013, 2014, 2015]
...
def test_flow_calc_sa(EWR_info, flows_data, expected_all_events):
	...
	all_events  = evaluate_EWRs.flow_calc_sa(EWR_info, flows_data, water_years, dates, masked_dates)
...
def test_flow_calc_check_ctf(EWR_info,flows_data,expected_all_events):
	...
	all_events  = evaluate_EWRs.flow_calc_check_ctf(EWR_info, flows_data, water_years, dates, masked_dates)

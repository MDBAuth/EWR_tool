...
class ScenarioHandler:
    ...
    def get_all_events(self)-> pd.DataFrame:
        ...
        all_events = summarise_results.join_ewr_parameters(cols_to_add=['Multigauge', 'State', 'sdl_unit'],
                        left_table=all_events,
                        left_on=['gauge','pu','ewr'],
                        selected_columns= ['scenario', 'gauge', 'pu', 'State', 'sdl_unit', 'ewr', 'waterYear', 'startDate', 'endDate',
    ...
    def get_all_interEvents(self)-> pd.DataFrame:
        ...
        all_events_temp = summarise_results.join_ewr_parameters(cols_to_add=['Multigauge', 'State', 'sdl_unit'],
    ...
    def get_all_successful_events(self)-> pd.DataFrame:
        ...
        all_events_temp1 = summarise_results.join_ewr_parameters(cols_to_add=['Multigauge', 'State', 'sdl_unit'],
    ...
    def get_all_successful_interEvents(self)-> pd.DataFrame:
        ...
        all_events_temp2 = summarise_results.join_ewr_parameters(cols_to_add=['Multigauge', 'State', 'sdl_unit'],
    ...
    def get_yearly_ewr_results(self)-> pd.DataFrame:
        ...
        yearly_ewr_results = summarise_results.join_ewr_parameters(cols_to_add=['Multigauge', 'State', 'sdl_unit'],
                                ...
                                selected_columns= ['Year', 'eventYears', 'numAchieved', 'numEvents', 'numEventsAll',
                                            ...
                                            'scenario', 'gauge', 'pu', 'State', 'sdl_unit', 'Multigauge'],
                                parameter_sheet_path=self.parameter_sheet)
